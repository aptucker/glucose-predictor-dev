...
callbacks = [[cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.29),
              cBacks.lrScheduler(refLoss=0.26, gain=0.08)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.29),
              cBacks.lrScheduler(refLoss=0.26, gain=0.1)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.29),
              cBacks.lrScheduler(refLoss=0.26, gain=0.1)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.29),
              cBacks.lrScheduler(refLoss=0.26, gain=0.1)]]
...
fileNames = ['C:\\Code\\glucose-predictor-dev\\misc_plots\\l12DayPlot.pdf',
             'C:\\Code\\glucose-predictor-dev\\misc_plots\\r12DayPlot.pdf']

cPlots.dayPredictionPlot(lPat.DayData[11], rPat.DayData[10], model, 12, True, fileNames)
