...
callbacks = [[cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.21),
              cBacks.lrScheduler(refLoss=0.16, gain=0.1)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.21),
              cBacks.lrScheduler(refLoss=0.16, gain=0.1)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.21),
              cBacks.lrScheduler(refLoss=0.16, gain=0.1)],
             [cBacks.EarlyStoppingAtMinLoss(patience = 20, baseLoss = 0.21),
              cBacks.lrScheduler(refLoss=0.16, gain=0.08)]]
